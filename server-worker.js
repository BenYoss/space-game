// NPM packages used to run this application
const {
  Worker,
  isMainThread,
  parentPort,
...
// package used ot read env variables
const envConfig = require("dotenv").config();

// import Ably Realtime framework
const Ably = require("ably");

//import p2 physics engine
const p2 = require("p2");

// reset env variable to local const
const ABLY_API_KEY = process.env.ABLY_API_KEY;


//declare const variables for game actions
...
// declare mutable variables for game actions
let players = {};
let playerChannels = {};
...
function calcRandomVelocity() {
  let randomShipXVelocity = between(30, 200);
